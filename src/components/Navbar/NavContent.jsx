            ...
            <div className='justify-between flex flex-row'>
                <div>
                    <ul className="md:flex hidden uppercase items-center gap-8 text-sm ml-4 p-4">
                        <li>
                            <Link to="/" className='px-3 inline-block hover:text-gray-600 flex flex-row'>
                        ...
                        <li>
                            <Link to="/daily-menu" className='px-3 inline-block hover:text-gray-600 flex flex-row'>
                        ...
                        <li>
                            <Link to="/dessert" className='px-3 inline-block hover:text-gray-600 flex flex-row'>
                        ...
                        <li>
                            <Link to="/vegetarian" className='px-3 inline-block hover:text-gray-600 flex flex-row'>
